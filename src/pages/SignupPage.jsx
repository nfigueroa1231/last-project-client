      ...
      <div className="px-10 mx-auto max-w-7xl">
        <div className="flex flex-wrap items-center justify-center">
          <div className="max-w-sm mb-16 lg:mb-0 lg:max-w-2xl lg:w-1/2 lg:px-4">
            <Link to="/" className="flex items-center mb-5 font-medium text-gray-900 lg:w-auto lg:items-center lg:justify-start md:mb-0">
              <span className="mx-auto text-2xl font-black leading-none text-gray-500 select-none">ExpressPay</span>
            </Link>
            <h2 className="mb-4 text-4xl font-bold tracking-tight lg:text-6xl xl:text-7xl">Signup today and we will autopay you're bills.</h2>
          </div>
              ...
              <div className="overflow-hidden text-center bg-white rounded-md shadow-sm">
                <div className="px-6 py-8">
                  ...
                  <form onSubmit={handleSignupSubmit} className="">
                    ...
                    <input className="py-2.5 px-4 mb-4 w-full bg-gray-50 border focus:ring-2 focus:ring-opacity-90 focus:ring-indigo-500 border-gray-100 rounded focus:outline-none" type="password" placeholder="Enter your password" name="password" value={newUser.password} onChange={handleTextChange} />
                  ...
                  <p className="text-xs text-gray-400">
                    ...
                    <Link to="/login" className="text-indigo-500">Sign In</Link>
                  </p>
                </div>
